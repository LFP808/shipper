...
// iPhone retail boxes (Apple slim eco-box, introduced iPhone 12):
//   mini/SE:   ~132 × 68 × 40 mm
//   standard:  ~148 × 76 × 40 mm
//   Plus/Max:  ~162 × 80 × 40 mm
// iPad retail boxes (thin flat box):
//   11"/Air 11": ~255 × 195 × 22 mm
//   12.9"/13":   ~295 × 225 × 22 mm

const IPHONE_BOX_MINI   = { boxLength: mm(132), boxWidth: mm(68), boxHeight: mm(40) }
const IPHONE_BOX_STD    = { boxLength: mm(148), boxWidth: mm(76), boxHeight: mm(40) }
const IPHONE_BOX_MAX    = { boxLength: mm(162), boxWidth: mm(80), boxHeight: mm(40) }
const IPAD_BOX_11       = { boxLength: mm(255), boxWidth: mm(195), boxHeight: mm(22) }
const IPAD_BOX_13       = { boxLength: mm(295), boxWidth: mm(225), boxHeight: mm(22) }
...
export const DEVICE_PRESETS: DevicePreset[] = [
  ...
  { id: 'iphone-12-pro',     category: 'iPhone', name: 'iPhone 12 Pro',     length: mm(146.7), width: mm(71.5), height: mm(7.4),  weightLb: g(189), ...IPHONE_BOX_STD  },
  { id: 'iphone-12-pro-max', category: 'iPhone', name: 'iPhone 12 Pro Max', length: mm(160.8), width: mm(78.1), height: mm(7.4),  weightLb: g(226), ...IPHONE_BOX_MAX  },
  // ── iPhone 13 ──────────────────────────────────────────────────────────────
  ...
  { id: 'iphone-13-pro',     category: 'iPhone', name: 'iPhone 13 Pro',     length: mm(146.7), width: mm(71.5), height: mm(7.65), weightLb: g(204), ...IPHONE_BOX_STD  },
  { id: 'iphone-13-pro-max', category: 'iPhone', name: 'iPhone 13 Pro Max', length: mm(160.8), width: mm(78.1), height: mm(7.65), weightLb: g(240), ...IPHONE_BOX_MAX  },
  // ── iPhone 14 ──────────────────────────────────────────────────────────────
  { id: 'iphone-14',         category: 'iPhone', name: 'iPhone 14',         length: mm(146.7), width: mm(71.5), height: mm(7.8),  weightLb: g(172), ...IPHONE_BOX_STD  },
  { id: 'iphone-14-plus',    category: 'iPhone', name: 'iPhone 14 Plus',    length: mm(160.9), width: mm(77.8), height: mm(7.8),  weightLb: g(203), ...IPHONE_BOX_MAX  },
  { id: 'iphone-14-pro',     category: 'iPhone', name: 'iPhone 14 Pro',     length: mm(147.5), width: mm(71.5), height: mm(7.85), weightLb: g(206), ...IPHONE_BOX_STD  },
  { id: 'iphone-14-pro-max', category: 'iPhone', name: 'iPhone 14 Pro Max', length: mm(160.7), width: mm(77.6), height: mm(7.85), weightLb: g(240), ...IPHONE_BOX_MAX  },
  // ── iPhone 15 ──────────────────────────────────────────────────────────────
  { id: 'iphone-15',         category: 'iPhone', name: 'iPhone 15',         length: mm(147.6), width: mm(71.6), height: mm(7.8),  weightLb: g(171), ...IPHONE_BOX_STD  },
  { id: 'iphone-15-plus',    category: 'iPhone', name: 'iPhone 15 Plus',    length: mm(160.9), width: mm(77.8), height: mm(7.8),  weightLb: g(201), ...IPHONE_BOX_MAX  },
  { id: 'iphone-15-pro',     category: 'iPhone', name: 'iPhone 15 Pro',     length: mm(146.6), width: mm(70.6), height: mm(8.3),  weightLb: g(187), ...IPHONE_BOX_STD  },
  { id: 'iphone-15-pro-max', category: 'iPhone', name: 'iPhone 15 Pro Max', length: mm(159.9), width: mm(76.7), height: mm(8.25), weightLb: g(221), ...IPHONE_BOX_MAX  },
  // ── iPhone 16 ──────────────────────────────────────────────────────────────
  { id: 'iphone-16',         category: 'iPhone', name: 'iPhone 16',         length: mm(147.6), width: mm(71.6), height: mm(7.8),  weightLb: g(170), ...IPHONE_BOX_STD  },
  { id: 'iphone-16-plus',    category: 'iPhone', name: 'iPhone 16 Plus',    length: mm(160.9), width: mm(77.8), height: mm(7.8),  weightLb: g(199), ...IPHONE_BOX_MAX  },
  { id: 'iphone-16-pro',     category: 'iPhone', name: 'iPhone 16 Pro',     length: mm(149.6), width: mm(71.5), height: mm(8.25), weightLb: g(199), ...IPHONE_BOX_STD  },
  { id: 'iphone-16-pro-max', category: 'iPhone', name: 'iPhone 16 Pro Max', length: mm(163.0), width: mm(77.6), height: mm(8.25), weightLb: g(227), ...IPHONE_BOX_MAX  },
  // ── iPhone 17 ──────────────────────────────────────────────────────────────
  { id: 'iphone-17',         category: 'iPhone', name: 'iPhone 17',         length: mm(149.6), width: mm(71.5), height: mm(7.95), weightLb: g(177), ...IPHONE_BOX_STD  },
  { id: 'iphone-17-pro',     category: 'iPhone', name: 'iPhone 17 Pro',     length: mm(150.0), width: mm(71.6), height: mm(8.3),  weightLb: g(206), ...IPHONE_BOX_STD  },
  { id: 'iphone-17-pro-max', category: 'iPhone', name: 'iPhone 17 Pro Max', length: mm(163.4), width: mm(78.0), height: mm(8.75), weightLb: g(233), ...IPHONE_BOX_MAX  },
